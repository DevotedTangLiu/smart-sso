...
<div class="row">
    <div class="col-xs-12">
        ...
        <form id="_editForm" class="form-horizontal" role="form"
            ...
            <input id="_uncheckAppIds" type="hidden" name="uncheckAppIds" value="">
                ...
                <div class="col-xs-12 col-sm-9">
                    <div class="clearfix help-validate">
                        <c:forEach var="item" items="${appList}">
                            <div class='col-sm-2'>
                                <label>
                                    <input name="appId" value="${item.id}" type="checkbox"
        ...
        jQuery(function ($) {
            ...
            $("#_submit").click(function () {
                if ($('#_editForm').validate()) {
                    ...
                    $("input[name='appId']:not(:checked)").each(function (i, d) {
                        if (i > 0) {
                            uncheckAppIds += ",";
                        }
                        uncheckAppIds += $(this).val();
                    });
                    $("#_uncheckAppIds").val(uncheckAppIds);
