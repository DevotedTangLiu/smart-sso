...
public class RoleController extends BaseController {
    ...
    public String execute(HttpServletRequest request, Model model, @ApiParam(value = "appId") Integer appId) {
    ...
    public String edit(HttpServletRequest request, @ApiParam(value = "id") Integer id, @ApiParam(value = "appId") Integer appId, Model model) {
    ...
    Result list(
        ...
        if (appId == null) {
            return Result.createSuccessResult().setData(new Pagination<Role>(pageNo, pageSize));
        }
